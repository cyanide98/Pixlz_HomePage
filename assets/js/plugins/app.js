...
$(document).ready(function() {
    ...
    $(".work-grid").cubeportfolio({
        ...
        lightboxGallery: !1,
        lightboxTitleSrc: "data-title",
        singlePageDelegate: ".cblp-singlePage",
        singlePageDeeplinking: !1,
        singlePageAnimation: "fade",
        singlePageStickyNavigation: !1,
        ...
        e.preventDefault();
        for (var t = $(this).serializeArray(), a = t.length, s = 0; a > s; s++) "true" == $("#contacts-form input[name='" + t[s].name + "']").attr("data-require-filling") ? t.push({
        ...
        $.ajax({
            type: "POST",
            url: "assets/contacts.php",
            data: t,
            dataType: "json",
            success: function(e) {
                $("#contacts-form .form-group").removeClass("error"), setTimeout(function() {
                    "" !== e.nameMessage && $("#contacts-form-name").parent().addClass("error"), "" !== e.emailMessage && $("#contacts-form-email").parent().addClass("error"), "" !== e.companyMessage && $("#contacts-form-company").parent().addClass("error"), "" !== e.phoneMessage && $("#contacts-form-phone").parent().addClass("error"), "" !== e.addressMessage && $("#contacts-form-address").parent().addClass("error"), "" !== e.subjectMessage && $("#contacts-form-subject").parent().addClass("error"), "" !== e.messageMessage && $("#contacts-form-message").parent().addClass("error")
                }, 25), "" !== e.succesMessage && ($("#contacts-form").addClass("success"), $("#contacts-form button span").removeClass("ti-arrow-right").addClass("ti-check"), $("#contacts-form input").attr("placeholder", ""), $("#contacts-form-message").attr("placeholder", e.succesMessage), $("#contacts-form input,#contacts-form button").val("").prop("disabled", !0))
            }
        })
    }), $("#contacts form button").hover(function() {
        $("#contacts form .form-group.button-container").addClass("move")
    }, function() {
        $("#contacts form  .form-group.button-container").removeClass("move")
    }), $("#contacts form input").focusin(function() {
        ...
        $("#contacts .map-wrapper").css("height", .8 * $("#contacts .map-wrapper").width())
    }), $('a[data-toggle="tab"]').on("shown.bs.tab", function() {
        $("#contacts .map-wrapper").css("height", .8 * $("#contacts .map-wrapper").width())
    });
    var t = "https://maps.googleapis.com/maps/api/js?key=AIzaSyDBn1m15RX-n27KRAc4sxOB_Z-3YSBsZx0&callback=initMap";
    "" != option_google_maps_api_key && "AIzaSyBibXe8KqGeC6orbxHN_32X2drJUN8WokWXE" != option_google_maps_api_key && (t = t + "?key=" + option_google_maps_api_key), loadScript(t, function() {
        ...
        if (0 != $("#map").length) {
            var t = new google.maps.LatLng(13.0317995, 80.1815177),
                a = 14,
                s = $(".block-contacts-1 .tab-content .map-wrapper .button-description .content-visible").css("background-color"),
                o = 12,
                l = 1;
